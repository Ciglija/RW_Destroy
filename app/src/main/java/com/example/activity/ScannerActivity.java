    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUcitajBazu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ScannerActivity.this, "Baza učitana", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnUnistavanje.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ScannerActivity.this, "Proces uništavanja pokrenut", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnZavrsi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ScannerActivity.this, "Proces završen", Toast.LENGTH_SHORT).show();
            }
        });
        btnKreirajIzvestaj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ScannerActivity.this, "Izveštaj kreiran", Toast.LENGTH_SHORT).show();
            }
        });
    }
}